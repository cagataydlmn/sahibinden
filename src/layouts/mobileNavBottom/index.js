...
export default function MobileNavBottom() {
    ...
    return (
        <div className="nav__media">
            <div className="fixed bottom-0 left-0 w-full bg-gradient-to-r from-indigo-600 to-blue-500 text-white shadow-xl py-2 flex justify-between items-center z-50 rounded-t-2xl">
