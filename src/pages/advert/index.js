                ...
                {step === 6 && (
                    <>
                        {selectedCategory === "FecwhXkriZmMzoepLg4E" ? (
                            <div className="car bg-gray-100 p-4 rounded-lg shadow-md space-y-4">
                                ...
                                <div className="car__title w-full ">
                                    ...
                                    <input
                                        ...
                                        className={`w-full h-10 border rounded px-3 focus:outline-none focus:ring-2 focus:ring-blue-400 ${!title ? 'border-red-500' : ''}`}
                                    />
                                </div>
                    ...
                    <div className="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-md flex flex-col">
                        ...
                        <div className="mt-6 flex flex-col md:flex-row justify-between gap-4">
                            <button
                                ...
                                className="px-6 py-3 bg-green-600 text-white rounded-lg shadow hover:bg-green-700 flex items-center justify-center gap-2"
