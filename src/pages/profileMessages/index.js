...
export default function ChatScreen() {
  ...
  return (
    <div>
      ...
      <div className="message__mobile bg-gray-200">
        <div className="messages flex h-screen bg-gray-300 font-sans justify-center items-center w-[75%]">
          <div className="border border-gray-300 rounded-lg w-full max-w-md h-full">
            <div className="  border-gray-300 flex h-full flex-col">
              {/* 1. Adım: Sohbet Listesi (Chat List) */}
              {!chatId && (
                <div className="w-full bg-gray-100 border-b border-gray-200 overflow-y-auto">
                  <div className="">
                    <ul className="space-y-2">
                      {sortedChats.map((chat) => {
                        const otherUserId = getOtherUserId(chat.userIds);
              ...
              {/* 2. Adım: Sohbet Detayı (Chat Details) */}
              {chatId && (
